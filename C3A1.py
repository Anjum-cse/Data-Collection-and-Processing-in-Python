...
output = nested[1][2]
print(output)
# 2. Below, a list of lists is provided. Use in and not in tests to create variables with Boolean
# values.
...
# 3. Below, we’ve provided a list of lists. Use in statements to create
...
if 'data' in nested:
    ...
    data = False
# Check to see if the integer 24 is in the value of the key data, if it is then assign to the
# variable twentyfour the value of True, otherwise False.
if 24 in nested:
    twentyfour = True
else:
    twentyfour = False
...
if 'whole' in nested:
    ...
    whole = False
# Check to see if the string 'physics' is a key in the dictionary nested. If it is,
...
# top four countries in the past three Olympics. Assign the value of Great Britain’s
# gold medal count from the London Olympics to the variable london_gold. Use indexing.
# Do not hardcode.
...
# Index into the dictionary to create variables that
...
# save the medal count for the USA from all three Olympics in
...
print(US_count)
# 8. Iterate through the contents of l_of_l
# and assign the third element
# of sublist to a new list called third.
