...
# 4. Use list comprehension to create a list called lst2
...
# one big list and assigned to the variable opposites
# if they are both longer than 3 characters each.

l1 = ['left', 'up', 'front']
l2 = ['right', 'down', 'back']
l3 = zip(l1, l2)
opposites = list(filter(lambda string: len(string[0])>3 and len(string[1])>3, l3))
print(opposites)
